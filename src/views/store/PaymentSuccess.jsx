...
function PaymentSuccess() {
  ...
  useEffect(() => {
    ...
    axios.post(`payment-success/${order.oid}/`, formData).then(res => {
                                    ...
                                    <div className="border border-3 border-success">
                                      <div className="card bg-white shadow p-5">
                                        ...
                                        <div className="text-center">
                                          <h1>Thank You !</h1>
                                          <p>
                                            Your checkout with order id{" "}
                                            <b>#{order.oid}</b> was successful,{" "}
                                            <br /> we have sent the order detail to
                                            your email <b>{order.email}</b>
                                          </p>
                                          <button
                                            className="btn btn-success mt-3 me-2"
                                            data-bs-toggle="modal"
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <div className="modal-body text-start text-black p-4">
                    ...
                    <h6>{order.mobile}</h6>
                    <h6 className="mb-5">
                      {order.address} - {order.city} <br /> {order.state} -{" "}
                      {order.country}
                    </h6>
